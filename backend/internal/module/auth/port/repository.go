...
type AuthRepository interface {
	...
	CreateUserIdentityWithTx(ctx context.Context, tx *sql.Tx, identity entity.UserIdentity) error
	FindUserIdentity(ctx context.Context, provider string, tenantID string, externalSubject string) (*entity.UserIdentity, error)
